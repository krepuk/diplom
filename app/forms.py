...
class CreateUserForm(FlaskForm):
    ...
    department = SelectField('Отдел поддержки (только для Админов)', choices=[('', 'Не требуется'), ('Участок №2', 'Участок №2'), ('Участок №3', 'Участок №3'), ('Участок №5', 'Участок №5'), ('Участок №8', 'Участок №8'), ('Участок №10', 'Участок №10'), ('Участок №11', 'Участок №11'), ('Участок №13', 'Участок №13'), ('Участок №18', 'Участок №18')])
...
class TicketForm(FlaskForm):
    ...
    category = SelectField('Область ошибки', choices=[('Участок №2', 'Участок №2'), ('Участок №3', 'Участок №3'), ('Участок №5', 'Участок №5'), ('Участок №8', 'Участок №8'), ('Участок №10', 'Участок №10'), ('Участок №11', 'Участок №11'), ('Участок №13', 'Участок №13'), ('Участок №18', 'Участок №18')], 
